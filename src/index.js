...
type ReflectedArg = $ReadOnly<{
  ...
  pattern?: any, // the default parameter
  customTypeNames?: Array<string>, // for matching custom types (like 'Person' or 'Car')
  subPatterns?: Array<any> // for OR patterns `(num = 2 | 4 | 6) => {}`
}>
